...
$(function() {
    ...
    $.fn.stepy.defaults.backLabel = '<i class="icon-arrow-left13 position-left"></i> Voltar';
    $.fn.stepy.defaults.nextLabel = 'Próximo <i class="icon-arrow-right14 position-right"></i>';

...
class Edit extends Component {
  ...
  componentDidMount() {
    ...
    api.LoadSistemaPorId(this.props.match.params.id)
      .then((res)=>
        this.setState({sistemas: res.data}),
        this.refs.projeto_nome.value = this.state.sistema.nome,
        this.refs.projeto_status.value = this.state.sistemas.status,
        this.refs.projeto_sistema.value = this.state.sistemas.sistema,
        this.refs.projeto_comentario.value = this.state.sistemas.comentario
      );
  ...
  render() {
    return <div>
      ...
      <Redirect to={this.state.redirect} />
        ...
        <Titulosecao title="Dashboard" titlelevel1="Editar Projeto" />
                    ...
                    <form action="#">                   
                        <div className="panel-body">
                          <div className="form-group">
                            ...
                            <input type="text" className="form-control"   placeholder={this.state.sistemas.nome} ref='projeto_nome' />
                          </div>
